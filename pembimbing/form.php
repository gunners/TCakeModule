...
$array_label = array("NIP : ","Tesis : ","");
$array_type = array("text","text","submit");
$array_name = array("id_pembimbing","nip","id_tesis","kirim");
$array_value = array("","","submit");
$array_class = "effect";
$array_id = array("id_pembimbing","nip","id_tesis","kirim");
$input_tag = array("<tr><td><fieldset>:</fieldset></td></tr>","<tr><td><fieldset>:</fieldset></td></tr>","<tr><td><div id='button'>:</div></td></tr>");
echo ("<form  id='pembimbing' action='".HOSTNAME."plugin/pembimbing/db_proses.php' method='POST'><center><table border='0'>");//
