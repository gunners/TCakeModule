...
<td align='center'><input type='image' id='del".$tesis[id_tesis]."'  src='".HOSTNAME.THEMES."default/images/icon/delete.png'> <input type='image' id='update".$tesis[id_tesis]."' src='".HOSTNAME.THEMES."default/images/icon/update.png'></td>
</tr>");
		$i++;
	}
	echo ("
