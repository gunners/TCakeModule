...
<td align='center'><input type='image' id='update".$dataruangan[kd_ruangan]."' src='".HOSTNAME.THEMES."default/images/icon/delete.png'> <input type='image' id='update".$dataruangan[kd_ruangan]."'  src='".HOSTNAME.THEMES."default/images/icon/update.png'></td>
</tr>");
		$i++;
	}
	echo ("
