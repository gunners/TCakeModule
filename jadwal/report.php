...
<td align='center'><input type='image' id='del".$jadwal[id_jadwal]."'  src='".HOSTNAME.THEMES."default/images/icon/delete.png'> <input type='image' id='update".$jadwal[id_jadwal]."' src='".HOSTNAME.THEMES."default/images/icon/update.png'></td>
</tr>");
		$i++;
	}
	echo ("
