...
<td align='center'><input type='image' id='del".$fakultas[kd_fakultas]."'  src='".HOSTNAME.THEMES."default/images/icon/delete.png'> <input type='image' id='update".$fakultas[kd_fakultas]."' src='".HOSTNAME.THEMES."default/images/icon/update.png'></td>
</tr>");
		$i++;
	}
	echo ("
