...
<td align='center'><input type='image' id='del".$matakuliah[kd_mk]."'  src='".HOSTNAME.THEMES."default/images/icon/delete.png'> <input type='image' id='update".$matakuliah[kd_mk]."' src='".HOSTNAME.THEMES."default/images/icon/update.png' id='update".$matakuliah[kd_mk]."'></td>
</tr>");
		$i++;
	}
	echo ("
